            ...
            <div className="flex items-center justify-center">
                ...
                <div className='mb:mt-8 mt-8'>
                    <div className='collection-card rounded-lg shadow-lg p-3'>
                        <h1 className='flex justify-center font-bold text-2xl text-left text-purple-400'>{props.title}</h1>
                        ...
                        <div className='mt-4 items-center justify-center grid col-start-2 col-end-3 text-purple-400'>
                            <p className="text-lg font-semibold">Lançamento: <span className='text-lg font-semibold text-orange-400'>{props.released}</span></p>
                            <p className="text-lg font-semibold">Onde assistir: <span className='text-lg font-semibold text-orange-400'>{props.platforms}</span></p>
                            <p className="text-lg font-semibold">Duração: <span className='text-lg font-semibold text-orange-400'>{props.duration} {movie ? ' minutos' : ' temporadas'}</span></p> 
                        </div>
                    </div>
