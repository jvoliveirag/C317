              ...
              <div className="mt-10 grid grid-cols-2 md:grid-cols-3 gap-6">
                ...
                <label className="flex justify-center relative cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                  <Options id='action' checked={gen_action} onChange={setAction} img={action} width={200} height={200}>
                    <p className="text-lg text-center font-bold tracking-wide text-purple-400">Ação</p>
                  </Options>
                </label>
                
                <label className="flex justify-center relative cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                  <Options id='comedy' checked={gen_comedy} onChange={setComedy} img={comedy} width={200} height={200}>
                    <p className="text-lg text-center font-bold tracking-wide text-purple-400">Comédia</p>
                  </Options>
                </label>

                <label className="flex justify-center relative cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                  <Options id='drama' checked={gen_drama} onChange={setDrama} img={drama} width={200} height={200}>
                    <p className="text-lg text-center font-bold tracking-wide text-purple-400">Drama</p>
                  </Options>
                </label>
                
                <label className="flex justify-center relative cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                  <Options id='fiction' checked={gen_fiction} onChange={setFiction} img={fiction} width={200} height={200}>
                    <p className="text-lg text-center font-bold tracking-wide text-purple-400">Ficção</p>
                  </Options>
                </label>

                <label className="flex justify-center relative cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                  <Options id='horror' checked={gen_horror} onChange={setHorror} img={horror} width={200} height={200}>
                    <p className="text-lg text-center font-bold tracking-wide text-purple-400">Terror</p>
                  </Options>
                </label>

                <label className="flex justify-center relative cursor-pointer transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                  <Options id='romance' checked={gen_romance} onChange={setRomance} img={romance} width={200} height={200}>
                    <p className="text-lg text-center font-bold tracking-wide text-purple-400">Romance</p>
                  </Options>
                </label>
