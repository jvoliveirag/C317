...
import { FaHome, FaEdit, FaTrashAlt, FaEyeSlash, FaEye} from "react-icons/fa";
...
export default function Recover(props: UserProps) {
    ...
    let senha = 'senha123'
    let show = false //logica para exibir/ocultar senha
                            ...
                            <div>
                                ...
                                <form className=''>
                                    <div className="login-form-inputs flex flex-1 flex-col gap-2 mt-8">
                                        ...
                                        <input type="email" name="email" placeholder={props.email} className='rounded-3xl' />
                                        <input type="password" name="password" placeholder={show ? props.password : '********'} className='rounded-3xl' />
                                        <input type="password" name="password" placeholder="Nova senha" className='rounded-3xl hidden-visible' />

                                        <div className={`mt-8 flex items-center justify-center gap-4 ${showEdit ? '' : 'hidden-visible'}`}>
                                            <button type="submit" className='font-medium flex items-center justify-center container text-white rounded-3xl h-10 text-xl bg-orange-400 md:font-bold hover:bg-purple-400 hover:text-white'>Salvar</button>
                                            <button type="submit" className='font-medium flex items-center justify-center container text-white rounded-3xl h-10 text-xl bg-orange-400 md:font-bold hover:bg-purple-400 hover:text-white'>Cancelar</button>
                                        </div>
