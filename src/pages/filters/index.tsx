...
export default function Filter() {
  ...
  const [durationSliderValue, setDurationSliderValue] = useState(MIN_DURATION_TV);
          ...
          <div className="flex items-center justify-center">
            ...
            <div className='mt-8 md:mt-0'>
              ...
              <div className='mt-8'>
                ...
                <RangeSlider initialValue={MIN_AGE} minValue={MIN_AGE} maxValue={MAX_AGE} onChange={handleAgeSliderChange}/>
              ...
              <div className='mt-4'>
                ...
                <RangeSlider initialValue={1} minValue={selectedOption === 'Filme' ? MIN_DURATION_MOVIE : MIN_DURATION_TV} maxValue={selectedOption === 'Filme' ? MAX_DURATION_MOVIE : MAX_DURATION_TV} onChange={handleDurationSliderChange}/>
              ...
              <div className='mt-4 text-white flex items-center'>
                ...
                <div className='flex items-center justify-center px-2'>
                  <span className=''>
                    <YearSelector minYear={1919} maxYear={2023} onChange={handleYearSelected}/>
                  </span>
                </div>
